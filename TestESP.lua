...
function TestESP:setESPBox(visible)
    self.espBox[2] = visible;
end;

function TestESP:setTracer(visible)
    self.tracer[2] = visible;
end;

function TestESP:setText(visible)
    self.name[2] = visible;
end;

function TestESP:update()
